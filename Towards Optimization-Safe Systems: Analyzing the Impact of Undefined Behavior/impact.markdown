...
Интуитивно, в стабильной программе указатель `p` не должен быть нулевым при разыменовании. Другими словами, отрицание условия UB, `p != NULL` должно выполнятсся всякий раз при исполнеии _e_. Ниже мы обобщили этот пример.
